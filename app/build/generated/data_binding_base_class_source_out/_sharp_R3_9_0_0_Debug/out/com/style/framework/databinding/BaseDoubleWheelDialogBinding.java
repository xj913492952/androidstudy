...
public final class BaseDoubleWheelDialogBinding implements ViewBinding {
  @NonNull
  ...
  private BaseDoubleWheelDialogBinding(@NonNull LinearLayout rootView, @NonNull TextView btnCancel,
  ...
  @NonNull
  public static BaseDoubleWheelDialogBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static BaseDoubleWheelDialogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.base_double_wheel_dialog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BaseDoubleWheelDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BaseDoubleWheelDialogBinding((LinearLayout) rootView, btnCancel, btnOk,
