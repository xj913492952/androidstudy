...
public final class DialogWebViewBinding implements ViewBinding {
  ...
  private DialogWebViewBinding(@NonNull LinearLayout rootView, @NonNull WebView webView) {
  ...
  public static DialogWebViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_web_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static DialogWebViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogWebViewBinding((LinearLayout) rootView, webView);
    }
